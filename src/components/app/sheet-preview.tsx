...
const SheetPreview = React.forwardRef<HTMLDivElement, { photos: Photo[][] }>((props, ref) => {
  const { 
    currentSheet, 
    setSelectedPhotoId
  } = useEditor();
